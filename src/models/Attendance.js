...
const Attendance = sequelize.define(
  "Attendance",
  {
    ...
    academicYearId: {
      type: DataTypes.UUID,
      allowNull: true, // ⚡ Set to true so legacy records without this ID do not crash
    },
  },
  {
    timestamps: true,
    indexes: [
      {
        name: "idx_attendance_tenant_class_date",
        fields: ["instituteId", "classId", "date"],
      },
      {
        name: "idx_attendance_tenant_student",
        fields: ["instituteId", "studentId"],
      },
